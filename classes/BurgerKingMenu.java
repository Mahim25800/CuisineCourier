...
public class BurgerKingMenu {
    ...
    public BurgerKingMenu() {
        ...
        frame = new JFrame("Burger King Menu");
        ...
        // Get the index of signupButton and add logoutButton at the same index
        // int signupButtonIndex = signupLoginLogoutPanel.getComponentZOrder(signupButton);
        // signupLoginLogoutPanel.add(logoutButton, signupButtonIndex);
        ...
        ImageIcon image1 = new ImageIcon(new ImageIcon("images/Chicken Stacker - (469).jpg").getImage().getScaledInstance(
        ...
        addToCartButton1.setBackground(new Color(0xf7161d));
        ...
        orderNowButton1.setBackground(new Color(0x0063b1));
        ...
        ImageIcon image2 = new ImageIcon(new ImageIcon("images/Creamy Double Cheese Burger - (389).jpg").getImage().getScaledInstance(
        400, 300, Image.SCALE_SMOOTH));
        ...
        addToCartButton2.setBackground(new Color(0xf7161d));
        ...
        orderNowButton2.setBackground(new Color(0x0063b1));
        ...
        ImageIcon image3 = new ImageIcon(new ImageIcon("images/Crispy king-(379).jpg").getImage().getScaledInstance(
        400, 300, Image.SCALE_SMOOTH));
        ...
        addToCartButton3.setBackground(new Color(0xf7161d));
        ...
        orderNowButton3.setBackground(new Color(0x0063b1));
        ...
        ImageIcon image4 = new ImageIcon(new ImageIcon("images/Fried Chicken - 2PC-(299).png").getImage().getScaledInstance(
        400, 300, Image.SCALE_SMOOTH));
        ...
        addToCartButton4.setBackground(new Color(0xf7161d));
        ...
        orderNowButton4.setBackground(new Color(0x0063b1));
        ...
        ImageIcon image5 = new ImageIcon(new ImageIcon("images/long Chees Bunger- (409).jpg")
        ...
        addToCartButton5.setBackground(new Color(0xf7161d));
        ...
        orderNowButton5.setBackground(new Color(0x0063b1));
        ...
        ImageIcon image6 = new ImageIcon(new ImageIcon("images/Whopper-(479).png").getImage()
        ...
        addToCartButton6.setBackground(new Color(0xf7161d));
        ...
        orderNowButton6.setBackground(new Color(0x0063b1));
    ...
    checkoutButton.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
            if (usarseeButton.isLoggedIn()) {
                new CheckOut(BurgerKingMenu.class);
                frame.setVisible(false);
                frame.dispose();
            } else {
                showLoginDialog();

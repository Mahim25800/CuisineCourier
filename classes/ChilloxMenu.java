...
public class ChilloxMenu {
    ...
    public ChilloxMenu(){
        ...
        ImageIcon image1 = new ImageIcon(new ImageIcon("images/beef cheese burger (235).jpg").getImage().getScaledInstance(
        ...
        addToCartButton1.setBackground(new Color(0x711010));
        ...
        orderNowButton1.setBackground(new Color(0xf8f7f2));
        ...
        ImageIcon image2 = new ImageIcon(new ImageIcon("images/chicken burger (210).jpg").getImage().getScaledInstance(
        400, 300, Image.SCALE_SMOOTH));
        ...
        addToCartButton2.setBackground(new Color(0x711010));
        ...
        orderNowButton2.setBackground(new Color(0xf8f7f2));
        ...
        ImageIcon image3 = new ImageIcon(new ImageIcon("images/chicken cheese burger (235).jpg")
        ...
        addToCartButton3.setBackground(new Color(0x711010));
        ...
        orderNowButton3.setBackground(new Color(0xf8f7f2));
        ...
        ImageIcon image4 = new ImageIcon(new ImageIcon("images/chicken fingers (175).jpg").getImage().getScaledInstance(
        400, 300, Image.SCALE_SMOOTH));
        ...
        addToCartButton4.setBackground(new Color(0x711010));
        ...
        orderNowButton4.setBackground(new Color(0xf8f7f2));
        ...
        ImageIcon image5 = new ImageIcon(new ImageIcon("images/Pankha wings (240).jpg").getImage().getScaledInstance(
        450, 300, Image.SCALE_SMOOTH));
        ...
        addToCartButton5.setBackground(new Color(0x711010));
        ...
        orderNowButton5.setBackground(new Color(0xf8f7f2));
        ...
        ImageIcon image6 = new ImageIcon(new ImageIcon("images/smoky bbq chicken chees (300).jpg").getImage().getScaledInstance(
        400, 300, Image.SCALE_SMOOTH));
        ...
        addToCartButton6.setBackground(new Color(0x711010));
        ...
        orderNowButton6.setBackground(new Color(0xf8f7f2));
    ...
    checkoutButton.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
            if (usarseeButton.isLoggedIn()) {
                new CheckOut(ChilloxMenu.class);
                frame.setVisible(false);
                frame.dispose();
            } else {
                showLoginDialog();

...
public class KFCMenu {
    ...
    public KFCMenu() {
        ...
        signupLoginLogoutPanel.setBackground(new Color(0x520102));
        ...
        ImageIcon image1 = new ImageIcon(new ImageIcon("images/6 PC BONELESS STRIPS (489).jpg").getImage().getScaledInstance(
        ...
        addToCartButton1.setBackground(new Color(0xb30627));
        ...
        ImageIcon image2 = new ImageIcon(new ImageIcon("images/CHICKEN POPCORN (219).jpg").getImage().getScaledInstance(
        400, 300, Image.SCALE_SMOOTH));
        ...
        addToCartButton2.setBackground(new Color(0xb30627));
        ...
        ImageIcon image3 = new ImageIcon(new ImageIcon("images/CHIZZA (399).jpg").getImage().getScaledInstance(
        400, 300, Image.SCALE_SMOOTH));
        ...
        addToCartButton3.setBackground(new Color(0xb30627));
        ...
        ImageIcon image4 = new ImageIcon(new ImageIcon("images/FRIED MEDIUM (159).jpg").getImage().getScaledInstance(
        400, 300, Image.SCALE_SMOOTH));
        ...
        addToCartButton4.setBackground(new Color(0xb30627));
        ...
        ImageIcon image5 = new ImageIcon(new ImageIcon("images/KFC BIG TREAT (999).jpg").getImage().getScaledInstance(
        400, 300, Image.SCALE_SMOOTH));
        ...
        addToCartButton5.setBackground(new Color(0xb30627));
        ...
        ImageIcon image6 = new ImageIcon(new ImageIcon("images/RIZO RICE (109).jpg").getImage().getScaledInstance(
        400, 300, Image.SCALE_SMOOTH));
        ...
        addToCartButton6.setBackground(new Color(0xb30627));

...
public class SultansDineMenu {
    ...
    public SultansDineMenu() {
        ...
        ImageIcon image1 = new ImageIcon(new ImageIcon("images/Basmati Kacchi -HAlf (269).png").getImage().getScaledInstance(
        ...
        JTextField textBox1= new JTextField("Basmati Kacchi -Half,269");
        ...
        addToCartButton1.setBackground(new Color(0x9b2e21));
        ...
        orderNowButton1.setBackground(Color.BLACK);
        ...
        ImageIcon image2 = new ImageIcon(new ImageIcon("images/Beef Rezala (180).png").getImage().getScaledInstance(
        400, 300, Image.SCALE_SMOOTH));
        ...
        JTextField textBox2= new JTextField("Beef Rezala,180");
        ...
        addToCartButton2.setBackground(new Color(0x9b2e21));
        ...
        orderNowButton2.setBackground(Color.BLACK);
        ...
        ImageIcon image3 = new ImageIcon(new ImageIcon("images/Borhani (70).jpeg").getImage().getScaledInstance(
        400, 300, Image.SCALE_SMOOTH));
        ...
        JTextField textBox3= new JTextField("Borhani,70");
        ...
        addToCartButton3.setBackground(new Color(0x9b2e21));
        ...
        orderNowButton3.setBackground(Color.BLACK);
        ...
        ImageIcon image4 = new ImageIcon(new ImageIcon("images/Chicken Roast (135).jpg").getImage().getScaledInstance(
        400, 300, Image.SCALE_SMOOTH));
        ...
        JTextField textBox4= new JTextField("Chicken Roast,135");
        ...
        addToCartButton4.setBackground(new Color(0x9b2e21));
        ...
        orderNowButton4.setBackground(Color.BLACK);
        ...
        ImageIcon image5 = new ImageIcon(new ImageIcon("images/Firni (70).png").getImage().getScaledInstance(
        400, 300, Image.SCALE_SMOOTH));
        ...
        JTextField textBox5= new JTextField("Firni,70");
        ...
        addToCartButton5.setBackground(new Color(0x9b2e21));
        ...
        orderNowButton5.setBackground(Color.BLACK);
        ...
        ImageIcon image6 = new ImageIcon(new ImageIcon("images/Plain Polao with Chicken Roast & Borhani (269).jpeg").getImage().getScaledInstance(
        400, 300, Image.SCALE_SMOOTH));
        ...
        JTextField textBox6= new JTextField("Plain Polao with Chicken Roast & Borhani,269");
        ...
        addToCartButton6.setBackground(new Color(0x9b2e21));
        ...
        orderNowButton6.setBackground(Color.BLACK);
    ...
    checkoutButton.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
            if (usarseeButton.isLoggedIn()) {
                new CheckOut(SultansDineMenu.class);
                frame.setVisible(false);
                frame.dispose();
            } else {
                showLoginDialog();
